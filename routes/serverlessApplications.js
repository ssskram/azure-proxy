...
router.get("/allServerlessApps", async (req, res) => {
  fetch(
    "https://management.usgovcloudapi.net/subscriptions/" +
      ...
      "/resourceGroups/lambdas/providers/Microsoft.Web/sites?api-version=2016-08-01",
    {
      method: "get",
      headers: new Headers({
...
router.get("/allFunctions", async (req, res) => {
  fetch(
    "https://management.usgovcloudapi.net/subscriptions/" +
      ...
      req.query.appName +
      "/functions?api-version=2016-08-01",
    {
      method: "get",
      headers: new Headers({
        Authorization: "Bearer " + (await refreshToken()),
...
router.get("/requests", async (req, res) => {
  fetch(
    "https://management.usgovcloudapi.net/subscriptions/" +
      ...
      req.query.appName +
      "/metrics?$filter=name.value eq 'Requests'&api-version=2016-08-01",
    {
      method: "get",
      headers: new Headers({
        Authorization: "Bearer " + (await refreshToken()),
...
router.get("/fourHundo", async (req, res) => {
  fetch(
    "https://management.usgovcloudapi.net/subscriptions/" +
      ...
      "/resourceGroups/client-applications/providers/Microsoft.Web/sites/" +
      req.query.appName +
      "/metrics?$filter=name.value eq 'Http4xx'&api-version=2016-08-01",
    {
      method: "get",
      headers: new Headers({
        Authorization: "Bearer " + (await refreshToken()),
...
router.get("/fiveHundo", async (req, res) => {
  fetch(
    "https://management.usgovcloudapi.net/subscriptions/" +
      ...
      "/resourceGroups/client-applications/providers/Microsoft.Web/sites/" +
      req.query.appName +
      "/metrics?$filter=name.value eq 'Http5xx'&api-version=2016-08-01",
    {
      method: "get",
      headers: new Headers({
        Authorization: "Bearer " + (await refreshToken()),
