...
router.get('/allClients',
    async function (req, res) {
        ...
        if (valid == true) {
            fetch("https://management.usgovcloudapi.net/subscriptions/07fefdba-84eb-4d6b-b398-ab8737a57f95/resourceGroups/client-applications/providers/Microsoft.Web/sites?api-version=2016-08-01", {
                    method: 'get',
                    headers: new Headers({
